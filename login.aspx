		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="panel-body">
					<%--<form action= "" role="form">--%>
						<fieldset>
                            ...
                            <asp:TextBox ID="txt_username" CssClass= "form-control" runat="server" 
                                     placeholder="Email" ValidationGroup="Login"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                ...
                ControlToValidate="txt_password" ErrorMessage="*" ForeColor="Red" ValidationGroup="Login"></asp:RequiredFieldValidator>
                                ...
                                <div>
                                <asp:Button ID="btn_login" CssClass="btn btn-primary" runat="server" Text="Login" ValidationGroup="Login" 
                CausesValidation="true" onclick="btn_login_Click" />
                                </div>
						</fieldset>
